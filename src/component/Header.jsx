...
export default function Header({cart, removeFromCart, increasequantity, decreasequantities, cleanCart}) {
                  ...
                  <tbody>
                    ...
                    <tr key={guitar.id}>
                      ...
                      <td className="flex align-items-start gap-4">
                        <button type="button" className="btn btn-dark" onClick={() => decreasequantities(guitar.id)}>
                          -
                        </button>
                        {guitar.cantidad}
